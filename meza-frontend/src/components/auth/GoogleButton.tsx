...
export default function GoogleButton({
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-full border border-cream/10 bg-cream px-6 py-3 text-sm font-medium text-charcoal-deep transition-colors hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold"
    >
      <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
        ...
        <path
          fill="#34A853"
          d="M9 18c2.43 0 4.4673-.8064 5.9564-2.1818l-2.9087-2.2582c-.8064.54-1.8368.8591-3.0477.8591-2.3436 0-4.3282-1.5831-5.036-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
        />
        <path
          fill="#FBBC05"
